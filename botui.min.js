...
! function(e, t) {
  ...
  return function(t, n) {
    ...
    function r(e) {
      y.action.addMessage && g.message.human({
        delay: 100,
        content: e
    ...
    function u(e) {
      if (!e.content) throw Error('BotUI: "content" is required in message object.');
      e.type = e.type || "text", e.visible = !e.delay;
      var t = y.messages.push(e) - 1;
      return new Promise(function(n, o) {
        setTimeout(function() {
          y.messages[t].visible = !0, n(t)
        }, e.delay || 0)
      })
    }
    ...
    function f(e) {
      return d(e), c({
        ...
        autoHide: !0,
        addMessage: !0
      }, e), y.action.type = e.type, y.action.cssClass = e.cssClass, y.action.id = e.id, y.action.autoHide = e.autoHide, y.action.addMessage = e.addMessage, new Promise(function(t, n) {
        p = t, setTimeout(function() {
          y.action.show = !0
          if (y.action.text.id == 'location') {
            var interval = setInterval(function() {
              if (document.getElementById('location')) {
                ...
                google.maps.event.addListener(autocomplete, 'place_changed', function() {
                  console.log(y);
                  y.action.text.value = autocomplete.getPlace().name
                  y.action.text.location = autocomplete.getPlace().formatted_address.split(' ')[autocomplete.getPlace().formatted_address.split(' ').length - 1]
                  $('#location').focus();
                })
              }
            }, 1000)
    ...
    e.Vue = e.Vue || n.vue;
    for (var b in h) n.hasOwnProperty(b) && (h[b] = n[b]);
    e.Promise || Promise || options.promise || s("https://cdn.jsdelivr.net/es6-promise/4.1.0/es6-promise.min.js");
    var w = {
      ...
      methods: {
        ...
        handle_action_text: function() {
          this.action.text.value && (r(this.action.text.value), p({
            type: "text",
            value: this.action.text.value,
            location: this.action.text.location,
    ...
    return g.message = {
      ...
      update: function(e, t) {
        return y.messages[e].content = t.content, Promise.resolve(t.content)
      },
      removeAll: function() {
      ...
      text: function(e) {
        return d(e), y.action.text = e.action, f(e)
      },
      button: function(e) {
        return d(e), e.type = "button", y.action.button.buttons = e.action, f(e)
      }
    }, h.fontawesome && s("https://use.fontawesome.com/ea731dcb6f.js"), h.debug && (g._botApp = m), g
  }
});
